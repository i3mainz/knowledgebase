...
import de.i3mainz.knowledgebase.Config;
 ...
 * designed for API-Version 2.7.14
 *
...
public class SesameConnect {
	 ...
	 */
	public static void SPARQLupdate(String repositoryID, String updateString) throws RepositoryException, MalformedQueryException, UpdateExecutionException, SQLException {
		try {
			...
			if (before == after) {
				throw new SQLException("NoInputException: [" + SesameConnect.class.getName() + " | " + Thread.currentThread().getStackTrace()[1].getMethodName() + "]");
			}
		} catch (Exception e) {
	 ...
	 * @throws java.sql.SQLException
	 */
	public static List<BindingSet> SPARQLquery(String repositoryID, String queryString) throws RepositoryException, MalformedQueryException, QueryEvaluationException, SQLException {
	 ...
	 * @throws java.sql.SQLException
	 */
	public static List<String> getValuesFromBindingSet_ORDEREDLIST(List<BindingSet> result, String var) throws QueryEvaluationException, SQLException {
	 ...
	 * @throws java.sql.SQLException
	 */
	public static HashSet<String> getValuesFromBindingSet_UNIQUESET(List<BindingSet> result, String var) throws QueryEvaluationException, SQLException {
	 ...
	 * @throws java.sql.SQLException
	 */
	public static ServletOutputStream SPARQLqueryOutputFile(String repositoryID, String queryString, String format, ServletOutputStream out) throws SQLException {
		try {
			String SesameSever = Config.TRIPLESTORE_SERVER;
			Repository repo = new HTTPRepository(SesameSever, repositoryID);
			repo.initialize();
	 ...
	 * @throws IOException
	 */
	private static int getNumberOfStatements(String repositoryID) throws MalformedURLException, IOException, SQLException {
		try {
